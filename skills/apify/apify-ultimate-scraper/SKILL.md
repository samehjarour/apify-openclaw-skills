...
metadata: {"openclaw":{"emoji":"🕷️","homepage":"https://apify.com","requires":{"env":["APIFY_TOKEN"],"bins":["node","mcpc"]},"primaryEnv":"APIFY_TOKEN","install":[{"id":"mcpc","kind":"node","package":"@apify/mcpc","bins":["mcpc"],"label":"Install mcpc CLI (npm)"}]}}
---
