...
const USER_AGENT = 'apify-agent-skills/apify-moltbook-scraper-1.0.0';
...
function printHelp() {
    console.log(`
Moltbook Scraper Runner - Scrape the AI agent social network

Usage:
  node --env-file=.env scripts/run_actor.js --actor sameh.jarour/moltbook-scraper --input '{}'

Options:
  --actor, -a       Actor ID (default: sameh.jarour/moltbook-scraper) [required]
...
Examples:
  # Quick answer - get latest posts
  node --env-file=.env scripts/run_actor.js \\
    --actor "sameh.jarour/moltbook-scraper" \\
    --input '{"scrapeMode": "posts", "maxItems": 20, "postSortBy": "new"}'

  # Export agents to CSV
  node --env-file=.env scripts/run_actor.js \\
    --actor "sameh.jarour/moltbook-scraper" \\
    --input '{"scrapeMode": "agents", "maxItems": 50, "agentSortBy": "karma"}' \\
    --output agents.csv --format csv
