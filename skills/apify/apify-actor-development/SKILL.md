...
metadata: {"openclaw":{"emoji":"🛠️","homepage":"https://apify.com","requires":{"env":["APIFY_TOKEN"],"bins":["apify"]},"primaryEnv":"APIFY_TOKEN","install":[{"id":"apify-cli","kind":"node","package":"apify-cli","bins":["apify"],"label":"Install Apify CLI (npm)"}]}}
---
